...
// content/01-basics/02-equations/02-quadratic/5-factoring/scripts/mental-roots.tsx
  ...
  return {
    problemContent: /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(ProblemHint, { children: [
        ...
        " в каждой скобке. Смотрите более подробные объяснения в задаче",
        " ",
        /* @__PURE__ */ jsx(Dep, { on: {"__ERUDIT_globalContentItem":true,"__path":"basics/equations/elementary/practice/$zeroFactors"}, children: "Нулевые множители" }),
        "."
      ] }),
