...
function createQuadraticProblem(tier) {
  const algorithm = {"__ERUDIT_globalContentItem":true,"__path":"basics/equations/quadratic/quadratic-formula/summary/$algorithm"};
  const examples = {"__ERUDIT_globalContentItem":true,"__path":"basics/equations/quadratic/quadratic-formula/article/$examples"};
...
// content/01-basics/02-equations/03-quadratic/4-quadratic-formula/scripts/quadratic/irrational.tsx
