...
export default defineProse({
    ...
    <>
        ...
        <Problem title="Кошки против... деревьев" level="easy">
            ...
            <ProblemHint>
                Обозначьте высоту дерева за 🌲, а высоту кота за 🐱. С использованием этих переменных посмотрите на
                каждую картинку и запишите изображенное на ней в виде уравнения.
            </ProblemHint>
            ...
            <ProblemSolution>
                <ProblemSection title="Прямое решение">
                    <P>
                        Смотрим на картинку и прямо в виде уравнений записываем. Для начала, нам неизвестна высота ни
                        дерева, ни кота. Обозначим их соответствующими эмоджи-переменными: 🌲 и 🐱.
                    </P>
                    <P>
                        На левой картинке мы видим, что высота кота плюс <M>200</M> это высота дерева. Записываем в виде
                        уравнения:
                    </P>
                    ...
                    <P>
                        В этом втором уравнении есть высота дерева 🌲. Но мы уже знаем из первого уравнения, что его
                        высота равна <M>😺 + 200</M>. Подставляем это вместо эмоджи дерева:
                    </P>
                    <BlockMath>{math`\underbrace{(🐱 + 200)}_{\large\phantom{M}🌲\phantom{M}} + 🐱 = 300`}</BlockMath>
                    <P>
                        Получили уравнения с одной перменной -- высотой кота 😺. Раскрываем скобки и приводим подобных
                        котов, то есть подобные слагаемые:
                    </P>
                    <BlockMath>{math`
                        🐱 + 200 + 🐱 = 300 \\
                        2🐱 + 200 = 300
                    `}</BlockMath>
                    <P>
                        Высоте кота остаться в одиночестве мешает умножение на <M>2</M> и сложение с <M>200</M>.
                        Избавимся сначала от сложения, по <Dep to={sameActionRule}>правилу</Dep> одинакового действия
                        вычтя из обеих частей уравнения <M>200</M>.
                    </P>
                    <BlockMath>{math`
                ...
                <ProblemSection title="Решение одним уравнением">
                    <P>
                        Можно сразу свести картинку к одному уравнению. Для этого нам нужен объект, высоту которого мы
                        хотим описать двумя способами. Пусть таким объектом будет дерево, а высоту кота обозначим
                        неизвестной 😺.
                    </P>
                    <P>
                        По левой картинке можно понять, что высота дерева равна <M>😺 + 200</M>. По правой, что высота
                        дерева равна <M>300 - 😺</M>. Но все одна и та же высота, поэтому можно записать уравнение:
                    </P>
                    <BlockMath>{math`🐱 + 200 = 300 - 🐱`}</BlockMath>
                    <P>
                        Сгруппируем высоту кота с одной стороны, например слева. Для этого по{' '}
                        <Dep to={sameActionRule}>правилу</Dep> одинакового действия прибавим к обеим частям уравнения
                        🐱. Тогда справа <M>-😺+😺</M> дадут в сумме <M>0</M>.
                    </P>
                    <BlockMath>{math`
                        \brand{+ 🐱} \ | \ 🐱 + 200 = 300 - 🐱 \ | \ \brand{+ 🐱} \\
                    ...
                    `}</BlockMath>
                    <P>
                        Дальше всё как в первом решении: избавляемся от сложения с <M>200</M>, вычитая его из обеих
                        частей уравнения, а потом делим обе части на <M>2</M>:
                    </P>
