    ...
    <>
        <Problems title="Игра с трёхчленами" level="easy">
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    <P>
                        Выражение уже почти имеет вид квадратного трёхчлена, но не хватает слагаемого с коэффициентом{' '}
                        <M>B</M>, который равен <M>0</M>:
                    </P>
                    <BlockMath>{math`j^2 + 0 \cdot j + 36`}</BlockMath>
                    <P>Коэффициенты:</P>
                    <BlockMath>{math`A = 1 >> B = 0 >> C = 36`}</BlockMath>
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    <P>
                        Чтобы привести его к такому виду, нам потребуется приравнять коэффициент <M>A</M> к <M>0</M>,
                        что противоречит <Dep to={quadraticPolynomial}>определению</Dep> квадратного трёхчлена:
                    </P>
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    ...
                    <P>
                        Выражение не может быть приведено к виду квадратного трёхчлена. Чтобы привести его к такому
                        виду,
                    </P>
                    <P>
        ...
        <Problems title="Точно квадратное уравнение?" level="easy">
            <P>
                Определите, является ли данное уравнение <Dep to={quadraticEquation}>квадратным</Dep>. Если да,
                приведите его к <B>общему виду</B> квадратного уравнения. Определите, чему равны его коэффициенты{' '}
                <M>A</M>, <M>B</M> и <M>C</M>.
            </P>
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    <P>
                        По <Dep to={sameActionRule}>правилу одинакового действия</Dep> вычитаем <M>y</M> из обеих
                        частей:
                    </P>
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    <P>
                        По <Dep to={sameActionRule}>правилу одинакового действия</Dep> вычитаем{' '}
                        <M>{math`\frac{6}{2}z^2`}</M> из обеих частей:
                    </P>
                    ...
                    `}</BlockMath>
                    <P>
                        Это уравнение не является квадратным, так как в нём нет слагаемого с <M>z^2</M>. А добавить его
                        с нулевым коэффициентом мы не можем, потому что это противоречит{' '}
                        <Dep to={quadraticPolynomial}>определению</Dep> квадратного трёхчлена:
                    </P>
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    <P>
                        По <Dep to={sameActionRule}>правилу одинакового действия</Dep> "вытаскиваем" <M>t</M> из
                        знаменателя, умножая обе части на <M>t</M>:
                    </P>
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    <P>
                        Видим с обеих сторон дробь с <M>x^2</M> в знаменателе. Можем одним действием избавиться от
                        дробей, умножив по <Dep to={sameActionRule}>правилу одинакового действия</Dep> обе части на{' '}
                        <M>x^2</M>, не забывая про <Dep to={alwaysGlobal}>глобальность</Dep> этого действия:
                    </P>
