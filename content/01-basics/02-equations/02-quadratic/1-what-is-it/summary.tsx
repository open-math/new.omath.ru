...
export default defineProse()(() => (
  <>
    ...
    <Hr />
    <P>
      <Dep to={sameActionRule}>Правило</Dep> одинакового действия, конечно, очень мощный инструмент, который позволяет
      легко справляться с простыми уравнениями доведением их до тривиального вида <M>x = A</M> или <M>A = x</M>. Однако
      часто встречаются и такие уравнения, которые до такого вида упростить нельзя:
    </P>
    ...
    <P>
      Если удаётся уравнение без изменения корней привести к такому виду, чтобы с одной стороны был квадратный трёхчлен,
      а с другой ноль, то такое уравнение называется "квадратным".
    </P>
