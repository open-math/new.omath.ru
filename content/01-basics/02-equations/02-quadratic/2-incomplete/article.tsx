...
export default defineProse({
  ...
  <>
    ...
    <P>
      Вы уже познакомились и научились распознавать <Dep to={whatIsQuadratic}>квадратные уравнения</Dep>. Теперь пришло
    ...
    >
      <P>
        <Dep to={quadraticEquation}>Квадратное уравнение</Dep>, у которого равен нулю коэффициент <M>B</M> или <M>C</M>{' '}
        или оба сразу:
      </P>
    ...
    <Statement title='Корень квадратного уравнения при "B" = 0 и "C" = 0'>
      ...
      <StatementProof>
        <P>
          ...
          <Dep to={equationSolution}>решение уравнения</Dep>.
        </P>
        <P>{QED}</P>
      </StatementProof>
    </Statement>
    ...
    <P>
      ...
      владения <Dep to={sameActionRule}>правилом одинакового действия</Dep> и умения решать уравнения из{' '}
      <Dep to={zeroFactors}>набора множителей, равных нулю</Dep>.
    </P>
    ...
    <Problems title='Квадратные уравнения при "C" = 0' level="easy">
      ...
      <SubProblem label="Образец">
        ...
        <ProblemSolution>
          ...
          <P>
            Подобные уравнения из набора множителей, равных нулю, мы уже <Dep to={zeroFactors}>решали ранее</Dep>.
    ...
    <Statement $={uniques.c0Roots} title='Корни квадратного уравнения при "C" = 0'>
      ...
      <StatementProof>
        ...
        `}</BlockMath>
        <P>
          Получаем <Dep to={zeroFactors}>типовой вид уравнения</Dep> с набором множителей с одной стороны и нулем с
