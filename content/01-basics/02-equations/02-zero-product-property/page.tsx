  ...
  <>
    ...
    >
      ...
      <StatementProof>
        ...
        <P>
          Давайте предположим, что существует ещё какой-то корень <M>x'</M>, который мы не смогли обнаружить по методу
          нулевых множителей. По определению, подстановка этого корня вместо неизвестной в уравнение должна дать верное
          равенство:
        </P>
        <BlockMath>{math`
