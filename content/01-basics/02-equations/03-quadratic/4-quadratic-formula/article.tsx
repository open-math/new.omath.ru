...
export default defineProse({
  ...
  <>
    ...
    <Reference to={$CONTENT.basics.equations.quadratic.quadraticFormula.practice.$sridharasMethod}>
    ...
    <Reference to={$CONTENT.basics.equations.quadratic.quadraticFormula.practice.$quadraticInF}>
